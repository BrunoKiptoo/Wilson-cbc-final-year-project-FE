...
export const ADMIN_DELETE_ALL_REQUEST = 'ADMIN_DELETE_ALL_REQUEST'
export const ADMIN_DELETE_ALL_SUCCESS = 'ADMIN_DELETE_ALL_SUCCESS'
export const ADMIN_DELETE_ALL_FAIL = 'ADMIN_DELETE_ALL_FAIL'
